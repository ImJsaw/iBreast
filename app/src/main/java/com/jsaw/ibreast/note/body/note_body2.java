...
public class note_body2 extends Fragment {
    private static final int[] IDS = new int[]{R.id.txtDate, R.id.txtTime, R.id.txtTemp};
    private static final String[] STRINGS = new String[]{"date", "time", "temp"};
...
//                5. int[] to Key的值要帶到哪個元件
                SimpleAdapter sa = new SimpleAdapter(getContext(), items, R.layout.body2_listview_item,
                        STRINGS, IDS);
