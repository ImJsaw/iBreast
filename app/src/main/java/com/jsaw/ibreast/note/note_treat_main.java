    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn2:
                btnC = 2;
                setColor(btnC);
                transaction.replace(R.id.center, new note_treat2(), "fragment2");
                break;
            case R.id.btn3:
                btnC = 3;
                setColor(btnC);
                transaction.replace(R.id.center, new note_treat3(), "fragment3");
                break;
            case R.id.btn4:
                btnC = 4;
                setColor(btnC);
                transaction.replace(R.id.center, new note_treat3(), "fragment4");
                break;
            case R.id.btn5:
                btnC = 5;
                setColor(btnC);
                transaction.replace(R.id.center, new note_treat3(), "fragment5");
                break;
            case R.id.Btn_edit:
                transaction.replace(R.id.center, new note_treat2_add(), "fragment2a");
                break;
        }
        //呼叫commit讓變更生效。
        transaction.commit();
