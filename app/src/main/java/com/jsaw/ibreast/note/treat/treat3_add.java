...
public class treat3_add extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_note_treat3_add);
        setDialog();
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.imgCalStart:
                datePickerDialog = new DatePickerDialog(treat3_add.this,
            ...
            case R.id.imgCheack:
                if (checkBlank()){
                    ...
                    Toast.makeText(treat3_add.this, message, Toast.LENGTH_SHORT).show();
                }
...
//                5. int[] to Key的值要帶到哪個元件
                SimpleAdapter sa = new SimpleAdapter(treat3_add.this, items, R.layout.note_list_view,
                        STRINGS, IDS) {
                    @Override
...
//                                    Toast.makeText(activity_note_my.this, "選中了" + map.get("item"), Toast.LENGTH_SHORT).show();
    ...
    private void saveData() {
        ...
        mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                String count = String.valueOf(dataSnapshot.child(user).child("標靶").getChildrenCount() + 1);
                mDatabase.child(user).child("標靶").child(count).setValue(part_record);
                mDatabase.child(user).child("標靶").child(count).child("startDate").setValue(edtStartDate.getText().toString());
                mDatabase.child(user).child("標靶").child(count).child("endDate").setValue(edtEndDate.getText().toString());
                progressDialog.dismiss();
                isProgressDialogShow = false;
                Toast.makeText(treat3_add.this, "儲存成功", Toast.LENGTH_SHORT).show();
                startActivity(new Intent().setClass(treat3_add.this, treat3.class));
            }
    ...
    private void setDialog() {
        progressDialog = new ProgressDialog(treat3_add.this);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                if (isProgressDialogShow) {
                    progressDialog.dismiss();
                    Toast.makeText(treat3_add.this, "連線逾時", Toast.LENGTH_SHORT).show();
                }
            }
        }, 5000);
    }
    ...
    private void setButtons() {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent().setClass(treat3_add.this, treat1.class));
            }
        });
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent().setClass(treat3_add.this, treat2.class));
            }
        });
        ...
        btn4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent().setClass(treat3_add.this, treat4.class));
            }
        });
        btn5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent().setClass(treat3_add.this, treat5.class));
            }
        });
